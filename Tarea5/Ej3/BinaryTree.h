...
class BinaryTree {
    ...
    public:
        ...
        bool simetria(BNode<T> *,BNode<T> *) const;
    ...
    template <class T>
    bool BinaryTree<T>::simetria(BNode<T> * nodeLeft,BNode<T> * nodeRight) const
    {
        if(nodeLeft && nodeRight)
        {
            if ((nodeLeft->getLeft() && nodeRight->getLeft()) || (!nodeLeft->getLeft() && !nodeRight->getLeft()))
            {
                if ((nodeLeft->getRight() && nodeRight->getRight()) || (!nodeLeft->getRight() && !nodeRight->getRight()) )
                {
                    if ((simetria(nodeLeft->getLeft(),nodeRight->getLeft())) && (simetria(nodeLeft->getRight(),nodeRight->getRight())))
                    {
                        return true;
                    }
                }
